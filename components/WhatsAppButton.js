    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative">
          {/* Popup Card */}
          {isOpen && (
            <div className="absolute bottom-16 right-0 mb-2 w-80 bg-white rounded-lg shadow-2xl border border-gray-200 transform transition-all duration-300 ease-out animate-in slide-in-from-bottom-2">
              <div className="p-4">
                ...
                <button
                  ...
                  className="w-full bg-[#25D366] hover:bg-[#20BA5A] text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
                >
